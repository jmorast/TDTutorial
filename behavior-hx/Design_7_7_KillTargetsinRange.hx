...
class Design_7_7_KillTargetsinRange extends ActorScript
{          	
...
/* ======================== When Creating ========================= */
        createBoxRegion((actor.getXCenter() - _RegionRadius), (actor.getYCenter() - _RegionRadius), (2 * _RegionRadius), (2 * _RegionRadius));
